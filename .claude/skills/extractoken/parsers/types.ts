...
export interface FindingsFile {
  readonly extractokenVersion: string;
...
export interface LlmTask {
  ...
  readonly promptPath: string; // .extractoken/prompts/normalize-color.md
  readonly responsePath: string; // .extractoken/llm-out/normalize-color.json
